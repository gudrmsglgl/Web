...
<body class="loading">
   <div id="wrapper">
      ...
      <div id="main">
         ...
         <hr>
         <h2>Comments Box</h2>
                   이곳은 회원님이 답변을 보낸 메세지들이 표시가 됩니다.
         <br>총 ${messageList.paging.totalCount} 개의 고민을 해결하셨습니다.
         <hr>
         <nav>
   ...
   <thead>
      <tr id="sendTh" height="50px" style="font-size:18pt;">
         <th scope="col">메세지 번호</th>
         <th scope="col">병이 흘러온 날짜</th>
         <th scope="col">카테고리</th>
         <th scope="col">키워드1</th>
         <th scope="col">키워드2</th>
         <th scope="col">고민을 해결한 날짜</th>
