...
<body class="loading">
	<div id="wrapper">
		...
		<div id="main">
			...
			<nav> <c:if test="${ empty messagiral }">
				<td>내용이 없습니다.</td>
			</c:if> <c:if test="${ not empty messagiral }">
				<c:forEach items="${messagiral.messageList}" var="messageVO">
					<form id="writeArticleForm">
						<table style="border: 1px solid #5ad2ff; font-size:18pt;" id="noticeTh">
							<tr height="50px">
								<th>카테고리 : ${messageVO.categoryId}</th>
							</tr>
						</table>
						
						<table style="border: 1px solid #5ad2ff; font-size:18pt; text-align: center;;" id="noticeTh">
							<tr height="50px">
								<th>키워드 1 : ${messageVO.keywordFirst}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								키워드 2 : ${messageVO.keywordSecond}</th>
						...
						<table style="border: 1px solid #5ad2ff" id="noticeTh">
							<td colspan="2"><textarea id="textarea" rows="4"
									...
									readonly="readonly">${messageVO.sendContent}</textarea></td>
						</table>
						...
						<table style="border: 1px solid #5ad2ff; font-size:18pt;" id="noticeTh">
							<tr height="50px">
								<td colspan="2"><textarea id="textarea" rows="4" cols="22"
										...
										readonly="readonly">${messageVO.receiveContent}</textarea></td>
							</tr>
						</table>
						...
						<table style="border: 1px solid #5ad2ff" id="noticeTh">
						<tr>
						<td>${messagiral.paging.getPagingList("pageNo"," [@] ", "◀-", "-▶")}</td>
						</tr>
						</table>
